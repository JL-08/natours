...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamwwOCIsImEiOiJja21kaGExY2sya240Mm93MGUwNTdndDJ4In0.Wsvlb4qq6WnQhpezYGAUsQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jl08/ckmdhq1omfobb17r1azob1hrm',
    scrollZoom: false //   center: [-117.65278729840699, 34.358268483601755],
    //   zoom: 10,
    //   interactive: false,
...
var stripe = Stripe('pk_test_51IXScfE2N27YjCf7718AW1TQaWI79XSqndxcyT1rDFnphniKNLdhlS021KcCpMTs6mFcWp5nMrBvWOZ81eIAPGBt00C3R9lUYj');
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    e.preventDefault(); // create multi form data
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // get the tour id from dataset attribute on the btn
